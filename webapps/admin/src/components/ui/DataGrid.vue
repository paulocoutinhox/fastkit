        ...
        <template v-else>
            <div class="hidden overflow-x-auto lg:block">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-line bg-sunken text-xs tracking-wide text-ink-muted uppercase">
                        <tr>
                    ...
                    <tbody class="divide-y divide-line">
                        <tr v-for="record in records" :key="record.id" class="transition hover:bg-highlight" :class="openable ? 'cursor-pointer' : ''" @click="open(record)">
