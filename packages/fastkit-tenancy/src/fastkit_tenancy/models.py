...
from fastkit_db.base import ActiveFlagMixin, Base, MetadataMixin, TimestampMixin, PrimaryKeyMixin
...
class Tenant(PrimaryKeyMixin, TimestampMixin, MetadataMixin, ActiveFlagMixin, Base):
    ...
    default_locale: Mapped[str] = mapped_column(String(12), default="en", nullable=False)
