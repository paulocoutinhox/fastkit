...
class User(PrimaryKeyMixin, TimestampMixin, MetadataMixin, Base):
    ...
    identifiers: Mapped[list["LoginIdentifier"]] = relationship(back_populates="user", cascade="all, delete-orphan", lazy="selectin")
    profile: Mapped["UserProfile"] = relationship(back_populates="user", cascade="all, delete-orphan", uselist=False, lazy="selectin")
