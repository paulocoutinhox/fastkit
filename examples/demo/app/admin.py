...
ADMIN_RESOURCES = [UserAdmin, CategoryAdmin, SubcategoryAdmin, ProductAdmin, ShowcaseAdmin, TenantAdmin, RoleAdmin, LanguageAdmin, ContentAdmin, ScheduledTaskAdmin, TaskExecutionAdmin, ReportRunAdmin, ActivityLogAdmin]
